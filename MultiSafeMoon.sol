...
pragma solidity ^0.6.12;
    ...
    contract MultiSafeMoon is Context, IERC20, Ownable {
        ...
        string private _name = 'MultiSafeMoon';
        string private _symbol = 'MSM';
        uint8 private _decimals = 9;
        
        uint256 private _taxFee = 4; 
        uint256 private _developmentFee = 15;
        ...
        constructor (address payable developmentWalletAddress, address payable marketingWalletAddress) public {
            ...
            IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xf2350eBaa37d6E8ECAF00422e72cB7e5426a06E8); 
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0xf2350eBaa37d6E8ECAF00422e72cB7e5426a06E8, 'We can not exclude Uniswap router.');
